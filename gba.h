...
// Timer registers
#define REG_TM0CNT (*(volatile unsigned short*) 0x04000102) // Timer 0 control register
#define REG_TM1CNT (*(volatile unsigned short*) 0x04000106) // Timer 1 control register
#define REG_TM2CNT (*(volatile unsigned short*) 0x0400010A) // Timer 2 control register
#define REG_TM3CNT (*(volatile unsigned short*) 0x0400010E) // Timer 3 control register
#define REG_TM0D   (*(volatile unsigned short*) 0x04000100) // Initial value for timer 0
#define REG_TM1D   (*(volatile unsigned short*) 0x04000104) // Initial value for timer 1
#define REG_TM2D   (*(volatile unsigned short*) 0x04000108) // Initial value for timer 2
#define REG_TM3D   (*(volatile unsigned short*) 0x0400010C) // Initial value for timer 3
...
// Interrupt registers
#define REG_IME       (*(unsigned short*) 0x04000208) // Interrupt (master) control register
...
#define REG_DISPSTAT (*(unsigned short*) 0x04000004) // Display interrupt register
#define REG_KEYCNT   (*(unsigned short*) 0x04000132) // Button interrupt register
